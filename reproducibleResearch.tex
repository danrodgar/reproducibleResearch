...
\begin{frame}{Introduction}{Components of reproducible research}
    ...
    \begin{itemize}
	\item Collaborative code development (\texttt{Git}, \texttt{GitHub})
	\item Experiment run (\texttt{Python})
	\item Statistical analysis (\texttt{R})
	\item Process documentation (\texttt{Markdown})
	\item Results writting (\texttt{Bookdown}, \texttt{Knitr}, \texttt{Swave})
	\item Assets publication (\texttt{GitHub})
    \end{itemize}
\end{frame}
